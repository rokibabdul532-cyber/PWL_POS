        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="barang_kode" value="{{ $barang->barang_kode }}" class="form-control" required>
                    <small id="error-barang_kode" class="error-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Nama Barang</label>
                    <input type="text" name="barang_nama" value="{{ $barang->barang_nama }}" class="form-control" required>
